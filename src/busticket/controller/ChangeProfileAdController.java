...
/**
 * Servlet implementation class ChangeProfileAdController
 */
@WebServlet("/ChangeProfileAd")
public class ChangeProfileAdController extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public ChangeProfileAdController() {
        super();
